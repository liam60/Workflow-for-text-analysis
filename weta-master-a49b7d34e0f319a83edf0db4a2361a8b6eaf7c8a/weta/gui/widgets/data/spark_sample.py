...
#         self.gui_parameters['withReplacement'] = ParameterWidget(parent_widget = self.box, label ='withReplacement', default_value ='False')
#         default_value = self.saved_gui_params.get('fraction', '0.5 ')
#         self.gui_parameters['fraction'] = ParameterWidget(parent_widget = self.box, label ='fraction', default_value ='0.5')
#         default_value = self.saved_gui_params.get('seed', '1')
#         self.gui_parameters['seed'] = ParameterWidget(parent_widget = self.box, label ='seed', default_value ='1')
#
