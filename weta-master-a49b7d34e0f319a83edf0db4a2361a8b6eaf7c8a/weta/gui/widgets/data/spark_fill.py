...
#         self.gui_parameters['value'] = ParameterWidget(parent_widget = self.box, label ='value', default_value = default_value)
#         default_value = self.saved_gui_params.get('subset', 'None')
#         self.gui_parameters['subset'] = ParameterWidget(parent_widget = self.box, label ='subset', default_value ='None')
#
